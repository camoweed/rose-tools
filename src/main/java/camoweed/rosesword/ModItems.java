...
public class ModItems {
    ...
    public static void initItems() {
        ...
        .build(new ItemArmor("item.roseBoots", MOD_ID + ":item/roseBoots", 17001, roseArmour, HumanArmorShape.BOOTS));
            rosePants = new ItemBuilder(MOD_ID)
        .build(new ItemArmor("item.rosePants", MOD_ID + ":item/rosePants", 17002, roseArmour, HumanArmorShape.LEGS));
            roseChest = new ItemBuilder(MOD_ID)
        .build(new ItemArmor("item.roseChest", MOD_ID + ":item/roseChest", 17003, roseArmour, HumanArmorShape.CHEST));
            roseHelm = new ItemBuilder(MOD_ID)
        .build(new ItemArmor("item.roseHelm", MOD_ID + ":item/roseHelm", 17004, roseArmour, HumanArmorShape.HEAD));
		roseAxe = new ItemBuilder(MOD_ID)
			.build(new ModRoseAxe("item.roseaxe", MOD_ID + ":item/roseaxe", 17005));
    }
}
